...
public abstract class Message {
    ...
    private UnsignedByte protocolVersion;
    private UnsignedInt sequentialNumber;
    private UnsignedShort envObjectID;
    ...
    public DatagramPacket pack() {
        ByteBuffer buffer = pack(ByteBuffer.allocate(headerBytes).
                put(protocolVersion.byteValue()).putInt(sequentialNumber.intValue()).putShort(envObjectID.shortValue()).
                putShort(port.shortValue()).put(type.byteValue()).array());
    ...
    public static <T extends Message> T unpack(DatagramPacket packet) throws AppException, NoSuchMethodException,
        ...
        UnsignedShort envObjectID = new UnsignedShort(buffer.getShort());
    ...
    protected abstract ByteBuffer pack(byte[] header);
